...
public class TestingHeap {
	...
	public static void main(String[] args) {
		...
		System.out.println(
				ANSI_CYAN_BACKGROUND + ROJO + "**************************************************************");
		System.out.println(
				ANSI_CYAN_BACKGROUND + ROJO + "*                     Test Arbol Heap MINIMO                 *");
		...
		System.out
				.println("Recupero cima de arbol, tiene que dar 15 " + (((int) a.recuperarCima() == 15) ? sOk : sErr));
		...
		System.out
				.println("Recupero cima de arbol, tiene que dar 10 " + (((int) a.recuperarCima() == 10) ? sOk : sErr));
		...
		System.out
				.println("Recupero cima de arbol, tiene que dar 12 " + (((int) a.recuperarCima() == 12) ? sOk : sErr));
